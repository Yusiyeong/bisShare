...
let inputElm2 = document.querySelector('input[name=ref]');
...
// attach events listeners
tagify2.on('dropdown:select', onSelectSuggestion) // allows selecting all the suggested (whitelist) items
      .on('edit:start', onEditStart)  // show custom text in the tag while in edit-mode
